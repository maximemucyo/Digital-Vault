						...
						<!--begin::Content-->
                            <div class="card border-left-primary shadow p-2 mt-5">
								<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
									<h6 class="m-0 font-weight-bold text-success">User Details</h6>
								</div>
                            <div class="card-body">
							<div class="card p-5">
								...
								<div class="flex-grow-1">
									...
									<div class="d-flex gap-15 align-items-start flex-wrap mb-2">
										...
										<div class="card d-flex flex-column col-md-6">
											...
											@endphp
											<form id="kt_account_balance_details_form" class="form" method="post" action="{{ route('balance.update', ['user' => $user]) }}">
											@csrf
											@method('patch')
											...
											<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
												...
												<input type="text" name="BTCUSDT" value={{$balance->BTCUSDT}} class="form-control form-control-lg form-control-solid" placeholder="0"  />
												</div>
												<!--end::Number-->
												<!--begin::Label-->
											...
											<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
												<!--begin::Number-->
												<div class="d-flex align-items-center">
												<input type="text" name="DOGEUSDT" value={{$balance->DOGEUSDT}} class="form-control form-control-lg form-control-solid" placeholder="0"  />
												</div>
												<!--end::Number-->
												<!--begin::Label-->
											...
											<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
												<!--begin::Number-->
												<div class="d-flex align-items-center">
												<input type="text" name="ETHUSDT"  value={{$balance->ETHUSDT}}   class="form-control form-control-lg form-control-solid" placeholder="0"  />
												</div>
												<!--end::Number-->
												<!--begin::Label-->
											...
											<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
												<!--begin::Number-->
												<div class="d-flex align-items-center">
												<input type="text" name="LTCUSDT" value={{$balance->LTCUSDT}}  class="form-control form-control-lg form-control-solid" placeholder="0"  />
												</div>
												<!--end::Number-->
												<!--begin::Label-->
