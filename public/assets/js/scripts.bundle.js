...
var KTThemeModeUser = function () {
    ...
    var handleSubmit = function() {
        ...
        KTThemeMode.on("kt.thememode.change", function() {                
            ...
            const logoElement = document.getElementById('vaultLogo');
            // Set logo source on theme
            if (mode === 'dark') {
                logoElement.src = 'assets/media/logos/dark_main_logo.png';
            } else {
                logoElement.src = 'assets/media/logos/light_main_logo.png'; 
            }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var links = document.querySelectorAll('.navi-link');
